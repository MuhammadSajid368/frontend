...
import { faker } from "@faker-js/faker"; // Assuming you're importing faker from a correct path
...
const Settings = () => {
  ...
  const list = [
    ...
    },
    {
      ...
      onclick: handleOpenShortcuts, // Corrected onclick
    },
    {
      key: 7,
      icon: <Info size={20} />,
